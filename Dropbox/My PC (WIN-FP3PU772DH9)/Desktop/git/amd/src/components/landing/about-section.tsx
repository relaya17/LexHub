        ...
        <div className="mt-8 text-center">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                <h4 className="font-headline font-semibold text-lg text-blue-600 mb-2">טכנולוגיה מתקדמת</h4>
                <p className="font-body text-gray-600">
                  שימוש בטכנולוגיות סריקה מתקדמות לדיגיטציה מדויקת של מסמכים
                </p>
              </div>
              <div>
                <h4 className="font-headline font-semibold text-lg text-blue-600 mb-2">מהירות גבוהה</h4>
                <p className="font-body text-gray-600">
                  עיבוד ודיגיטציה מהירה של מסמכים תוך זמן קצר
                </p>
              </div>
              <div>
                <h4 className="font-headline font-semibold text-lg text-blue-600 mb-2">תמיכה 24/7</h4>
                <p className="font-body text-gray-600">
